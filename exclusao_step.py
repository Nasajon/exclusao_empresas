...
class ExclusaoStep(Step):
    ...
    def conta_tabela_excluir(self, entidade: Dict[str, Any]):
        ...
        return self.db_adapter.execute_query_first_result(sql, table={entidade['table_name']})['qtd']
    ...
    def main(self, data: str):
        ...
        try:
            ...
            self.limpar_fks_estabelecimentos_usuarios(
            ...
            for entidade in entidades:
                ...
                self.log('Guardando os scritps para recriar as FKs...')
                scripts_create_fks_novos = self.get_scripts_create_fks(
                    entidade)
